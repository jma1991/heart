...
```{r}
sce <- readr::read_rds(here::here("data/integration.Rds"))
```
...
<!-- Select perplexity value to balance attention between local and global aspects of the data: -->

<!-- ```{r} -->
<!-- set.seed(1701) -->

<!-- sce <- runTSNE(sce, dimred = 'PCA', perplexity = 35) -->
<!-- ``` -->
...
<!-- Select number of nearest neighbors to identify when constructing the initial graph: -->

<!-- ```{r} -->
<!-- set.seed(1701) -->

<!-- sce <- runUMAP(sce, dimred = 'PCA', n_neighbors = 47) -->
<!-- ``` -->
