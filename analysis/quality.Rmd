...
knitr::opts_chunk$set(
  autodep    = TRUE,
  cache      = TRUE,
  cache.path = "cache/02-quality-control",
  dev        = "png",
  error      = FALSE,
  message    = FALSE,
  warning    = FALSE
...
patchwork::wrap_plots(
  plotColData(sce, "log10_total_counts", "plate", colour_by = "genotype"),
  plotColData(sce, "log10_total_features_by_counts", "plate", colour_by = "genotype"),
  plotColData(sce, "pct_counts_ERCC", "plate", colour_by = "genotype"),
  plotColData(sce, "pct_counts_MT", "plate", colour_by = "genotype")
)
```
...
```{r}
qc1 <- sce$total_counts < 10000
qc2 <- sce$total_features_by_counts < 1000
...
```{r}
patchwork::wrap_plots(
    plotColData(sce, x = "plate", y = "log10_total_counts", colour_by = "genotype", shape_by = "manual"),
    plotColData(sce, x = "plate", y = "log10_total_features_by_counts", colour_by = "genotype", shape_by = "manual"),
    plotColData(sce, x = "plate", y = "pct_counts_MT", colour_by = "genotype", shape_by = "manual"),
    plotColData(sce, x = "plate", y = "pct_counts_ERCC", colour_by = "genotype", shape_by = "manual"),
    ncol = 2
)
```
...
```{r}
patchwork::wrap_plots(
    plotColData(sce, x = "plate", y = "log10_total_counts", colour_by = "genotype", shape_by = "adaptive"),
    plotColData(sce, x = "plate", y = "log10_total_features_by_counts", colour_by = "genotype", shape_by = "adaptive"),
    plotColData(sce, x = "plate", y = "pct_counts_MT", colour_by = "genotype", shape_by = "adaptive"),
    plotColData(sce, x = "plate", y = "pct_counts_ERCC", colour_by = "genotype", shape_by = "adaptive"),
    ncol = 2
)
```
...
```{r}
run <- runPCA(sce, use_coldata = TRUE, detect_outliers = TRUE)
...
```{r}
patchwork::wrap_plots(
    plotColData(sce, x = "plate", y = "log10_total_counts", colour_by = "genotype", shape_by = "outlier"),
    plotColData(sce, x = "plate", y = "log10_total_features_by_counts", colour_by = "genotype", shape_by = "outlier"),
    plotColData(sce, x = "plate", y = "pct_counts_MT", colour_by = "genotype", shape_by = "outlier"),
    plotColData(sce, x = "plate", y = "pct_counts_ERCC", colour_by = "genotype", shape_by = "outlier"),
    ncol = 2
)
```
